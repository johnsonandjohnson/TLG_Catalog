...
lsting <- adex %>%
  mutate(
    ...
    COL6 = paste(stringr::str_to_sentence(ADOSFRM),
      ADOSFRQ,
    ...
    COL9 = case_when(
      toupper(AREASOC) == "OTHER" ~
        paste(stringr::str_to_sentence(AREASOC), stringr::str_to_sentence(AREASOO), sep = ": "),
    ...
    COL10 = case_when(
      toupper(AADJ) == "OTHER" ~
        paste(stringr::str_to_sentence(AADJ), stringr::str_to_sentence(AADJOTH), sep = ": "),
