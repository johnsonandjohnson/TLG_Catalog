...
lyt <- lyt %>%
  analyze("STUDYID", var_labels = "Total number of cycles received",
          afun = a_freq_j, 
  ...
  analyze("AVALCAT1", nested = FALSE, var_labels = "Total number of cycles received, n (%)", 
          afun = a_freq_j, 
  ...
  analyze("CRIT1FL",
    ...
    afun = a_freq_j, 
    extra_args = list(val = "Y", label =  critlbls[[1]],denom = "n_df", .stats = c("count_unique_fraction")),
    indent_mod = 1L, show_labels = "visible", nested = FALSE
  )
