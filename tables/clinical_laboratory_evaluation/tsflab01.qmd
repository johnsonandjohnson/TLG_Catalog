...
adsl <- pharmaverseadamjnj::adsl %>%
  filter(.data[[popfl]] == "Y") %>%
  select(STUDYID, USUBJID, all_of(c(popfl, trtvar)), SEX, AGEGR1, RACE, ETHNIC, AGE)
...
build_result_parcat3 <- function(df = filtered_adlb, df_timepoints = filtered_adlb_timepoints,
                                 df_orig = adlb00,
