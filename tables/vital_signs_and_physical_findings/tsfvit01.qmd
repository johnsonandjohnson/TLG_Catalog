...
vs_precision <- tidytlg:::make_precision_data(df = advs00, decimal = 3, precisionby = "PARAMCD", precisionon = "AVAL")
...
lyt <- basic_table(show_colcounts = FALSE, colcount_format = "N=xx") %>%
  ### first columns
  split_cols_by("colspan_trt", split_fun = trim_levels_to_map(map = colspan_trt_map), show_colcounts = FALSE) %>%
