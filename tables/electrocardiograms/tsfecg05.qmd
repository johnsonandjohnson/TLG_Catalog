---
title: TSFECG05
subtitle: Subjects With ECG Values Outside Specified Limits Based on On-treatment Value and Over Time
---
...
selvisit <- c("Month 1", "Month 3", "Month 6", "Month 9", "Month 12", "Month 15", "Month 18", "Month 24")
...
# restrict to these
selparamcd <- as.character(unique(levels_data %>% filter(!(is.na(CRIT1) | is.na(CRIT2))) %>% pull(PARAMCD)))
...
extra_args_rr2 <- list(method = "wald", denom = "n_df", .stats=c("count_unique_fraction"))
