...
eg_precision <- tidytlg:::make_precision_data(df = adeg00, decimal = 4, precisionby = "PARAMCD", precisionon = "AVAL")
...
## issue with sysntethic data for Apalutamide Subgroup : 600 records rather than 300
...
lyt <- basic_table(show_colcounts = FALSE, colcount_format = "N=xx") %>%
  ...
  split_rows_by("PARAM", label_pos = "topleft", split_label = obj_label(filtered_adeg$PARAM), section_div = " ", split_fun = drop_split_levels) %>%
