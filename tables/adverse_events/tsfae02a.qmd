...
lyt <- lyt %>%
  ...
  summarize_row_groups(subgrpvar,
                       cfun =a_freq_j,
...
if (length(adae$TRTEMFL) != 0) {
  result <- sort_at_path(result, c(subgrpvar, "*", "TRTEMFL", "*", "AEBODSYS"), scorefun = jj_complex_scorefun())
  result <- sort_at_path(result, c(subgrpvar, "*", "TRTEMFL", "*", "AEBODSYS", "*", "AEDECOD"),
