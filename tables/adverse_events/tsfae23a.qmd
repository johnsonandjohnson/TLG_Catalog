---
title: TSFAE23A
subtitle: Subjects With Related Treatment-emergent Serious Adverse Events by Preferred Term
---
...
adae0 <- pharmaverseadamjnj::adae %>%
  ...
  select(
    ...
    TRTEMFL, AESER, AEDECOD, colspan_trt
  )
...
lyt <- lyt %>%
  analyze(
    ...
    show_labels = "hidden",
    afun = a_freq_j,
    extra_args = list(label = "Subjects with >=1 related SAE",
