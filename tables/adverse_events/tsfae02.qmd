---
title: TSFAE02
subtitle: Subjects With Treatment-emergent Adverse Events by System Organ Class and Preferred Term
---
...
lyt <- lyt %>%
    analyze("TRTEMFL", afun = a_freq_j,
            extra_args = append(extra_args_rr2,list(val="Y", label = "Subjects with >=1 AE")))  %>%
