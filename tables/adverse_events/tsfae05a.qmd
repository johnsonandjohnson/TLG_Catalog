---
title: TSFAE05A
subtitle: Subjects With Treatment-emergent Related Adverse Events by System Organ Class, Preferred Term, and Subgroup
---
...
lyt <- lyt %>%
  ...
  summarize_row_groups("TRTEMFL", cfun = a_freq_j, indent_mod = 0L, 
                       extra_args = append(extra_args_rr2,list(label =  "Subjects with >=1 related AE", extrablankline = TRUE))) %>%
