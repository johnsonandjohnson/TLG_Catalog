...
## ----variant1, results='hide', warning = FALSE, message = FALSE------------------------------------------------------------------------
...
lyt <- lyt %>%
  ...
  analyze(
    ...
    var_labels = "Duration~[super a], ([unit])",
    show_labels = "visible",
    indent_mod = 0L,
    extra_args = list(
      daysconv = daysconv,
...
## ----result1, echo=FALSE, message=FALSE, warning=FALSE, test = list(result_v1 = "result")----------------------------------------------
tt_to_flextable_j(head(result, 25), tblid, markup_df  = docx_markup_df)
