...
## R version:                 4.2.1
## Short Description:         Baseline vs. Minimum Postbaseline [Vital Sign Parameter]
...
pt_sys <- g_scatter(
  ...
  y_label = "Minimum Post-baseline Systolic Blood Pressure (mmHg)"
)
...
pt_dia <- g_scatter(
  ...
  y_label = "Minimum Post-baseline Diastolic Blood Pressure (mmHg)"
)
...
pname_sys_min <- paste0(tolower(tblid), "_sys_min", ".png")

png(
  write_path(opath, pname_sys_min),
  width = 16,
  height = 18,
  units = "cm",
  res = 300,
...
print(write_path(opath, pname_sys_min)) ### print png path and name in log
print(pt_sys)
dev.off()

pname_dia_min <- paste0(tolower(tblid), "_dia_min", ".png")

png(
  write_path(opath, pname_dia_min),
  width = 16,
  height = 18,
  units = "cm",
  res = 300,
...
print(write_path(opath, pname_dia_min)) ### print png path and name in log
print(pt_dia)
dev.off()

tidytlg::gentlg(
  tlf = "g",
  plotnames = write_path(opath, c(pname_sys_min, pname_dia_min)),
  # plotwidth   = 10,
