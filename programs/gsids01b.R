...
################################################################
### Source: programs/gsids01b.R
################################################################


################################################################################
## Original Reporting Effort: Standards
## Program Name:              gsids01b.R
## R version:                 4.2.1
## Short Description:         Time to Last Follow-up
...
adttesaf <- pharmaverseadamjnj::adttesaf %>%
  # filter(PARAMCD == "TTLASTFU", SAFFL == "Y") %>%
  filter(PARAMCD == "TTLSTFUM", SAFFL == "Y") %>%
...
y_label <- "Percentage of Subjects Remaining in Follow-up"
