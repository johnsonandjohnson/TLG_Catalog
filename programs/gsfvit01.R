...
## R version:                 4.2.1
## Short Description:         Mean and 95% Confidence Interval of Blood Pressure Over Time
...
pt_sys_1 <- g_line(df = advs_sys_1)

# call for Systolic blood pressure part 2
pt_sys_2 <- g_line(df = advs_sys_2)
...
pt_dia_1 <- g_line(df = advs_dia_1)

# call for Diastolic blood pressure part 2
pt_dia_2 <- g_line(df = advs_dia_2)
...
tidytlg::gentlg(
  ...
  plotnames = write_path(
    opath,
    c(pname_sys_1, pname_sys_2, pname_dia_1, pname_dia_2)
  ),
  plotwidth = 8,
