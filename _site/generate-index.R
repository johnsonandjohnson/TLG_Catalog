...
create_subsection("./tables/adverse_events_for_japan_submission", "Adverse Events for Japan Submission")
create_subsection("./tables/clinical_laboratory_evaluation", "Clinical Laboratory Evaluation")
create_subsection("./tables/demographic_and_other_baseline_characteristics", "Demographic and Other Baseline Characteristics")
...
create_subsection("./listings/demographic_and_other_baseline_characteristics", "Demographic and Other Baseline Characteristics")
